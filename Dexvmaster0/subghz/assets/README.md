...
You'll need to edit the [extended range file](https://github.com/DXVVAY/Dexvmaster0/blob/main/documentation/DangerousSettings.md) to enable frequencies outside of the Official above.
